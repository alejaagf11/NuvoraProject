...
import com.nuvora.backend_finanzas.service.implement.LeccionServiceImp;
...
public interface ProgresoLeccionUsuarioRepository extends JpaRepository<ProgresoLeccionUsuario, Long>{
    ...
    boolean existsByUsuarioAndLeccionAndCompletadaTrue(Usuario usuario, Leccion leccion);
}
